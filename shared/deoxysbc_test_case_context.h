...
*/
#ifndef _DEOXYS_BC_TEST_CASE_CONTEXT_H_
#define _DEOXYS_BC_TEST_CASE_CONTEXT_H_
 ...
 */
class DeoxysBCTestCaseContext {
 public:
    DeoxysBCTestCaseContext() = default;

    explicit
    DeoxysBCTestCaseContext(const size_t num_plaintext_bytes,
...
#endif  // _DEOXYS_BC_TEST_CASE_CONTEXT_H_
