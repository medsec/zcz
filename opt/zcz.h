...
#define ZCZ_NUM_DI_BLOCKS_PER_SEQUENCE   8
#define ZCZ_NUM_BLOCKS_PER_SEQUENCE      16
#define ZCZ_NUM_BYTES_PER_SEQUENCE       256
...
typedef deoxys_bc_block_t zcz_tweak_t;
typedef uint8_t zcz_key_t[DEOXYS_BC_128_KEYLEN];
